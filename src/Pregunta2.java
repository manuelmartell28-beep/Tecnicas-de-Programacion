 ...
 * Este programa solicita al usuario que ingrese dos números enteros y realiza una división.
 * Implementa un bloque try-catch para manejar de forma segura el error que
 * ocurre cuando se intenta dividir entre cero (ArithmeticException).
 * @author TuNombre
 */
